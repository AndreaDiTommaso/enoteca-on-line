<?php /* Smarty version 2.6.26, created on 2019-05-15 17:15:34
         compiled from ricerca_default_amministratore.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'ricerca_default_amministratore.tpl', 29, false),)), $this); ?>
...
?>
            ...
            <div class="content-2col-box">
              <h1><a href="?controller=ricerca&task=dettagli&id_vino=<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['ISBN']; ?>
"><?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['nome']; ?>
</a></h1>
              <p><img height="200" src="copertine/<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['immagine']; ?>
" alt="<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['nome']; ?>
" title="<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['nome']; ?>
"}</p>
...
?>
              ...
              <p class="details">
				<ul>
					<li><b>Media Voti:</b> <a href="#"><?php if ($this->_tpl_vars['dati'][$this->_sections['i']['index']]['media_voti'] > 0): ?><?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['media_voti']; ?>
<?php else: ?>-<?php endif; ?></a> </li>
					<li>	Categoria: <a href="#"><?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['categoria']; ?>
</a> </li>
					<li> Prezzo: <a href="#"><?php echo ((is_array($_tmp=$this->_tpl_vars['dati'][$this->_sections['i']['index']]['prezzo'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</a> </li>
				</ul>
			</p>
              <form action="index.php" method="post">
              <input type="hidden" name="id_vino" value="<?php echo $this->_tpl_vars['dati'][$this->_sections['i']['index']]['ISBN']; ?>
" />
...
" />
		...
		<?php if ($this->_tpl_vars['task'] == 'lista'): ?>
